...
public abstract class Tree {
    ...
    /**
     * Repeat-loops, of type WhileLoop.
     */
    ...
    public static final int CONOP = MOD + 1;

    public static final int NULL = CONOP + 1;
    ...
    public static final int SWITCHBLOCK = STRING + 1; 
    public static final int DEFAULTCASE = SWITCHBLOCK + 1; 
    public static final int CASEBLOCK = DEFAULTCASE + 1; 
   ...
   public static class SwitchBlock extends Tree {
       ...
       public SwitchBlock(List<Tree> cases, Location loc) {
   ...
   public static class Switch extends Tree {
   	...
   	public Expr expr;
   	public SwitchBlock sb;

       public Switch(Expr expr, SwitchBlock sb, Location loc) {
           super(SWITCH, loc);
           this.expr = expr;
   		this.sb = sb;
       }
   ...
   public static class Case extends Tree {
       ...
       public Case(Expr expr, CaseBlock cb, Location loc) {
           super(CASE, loc);
           this.expr = expr;
   		this.cb = cb;
       }
   ...
   /**
     * An default
     */
   public static class DefaultCase extends Tree {
   	
   	public CaseBlock cb;

       public DefaultCase(CaseBlock cb, Location loc) {
           super(DEFAULTCASE, loc);
   		this.cb = cb;
       }

   	@Override
       public void accept(Visitor v) {
           v.visitDefaultCase(this);
       }
  ...
  public static abstract class Visitor {
      ...
      public void visitDefaultCase(DefaultCase that) {
          visitTree(that);
      }
